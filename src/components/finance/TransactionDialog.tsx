...
import { financeActions, GRUPO_LABELS, useFinance, type Transaction } from "@/lib/finance-store";
...
export function TransactionDialog({ open, onOpenChange, editing, defaultTipo = "despesa" }: Props) {
  ...
  }, [open, editing, defaultTipo, initial]);
      ...
      <DialogContent className="glass-elevated max-w-lg p-0 sm:rounded-2xl">
        <form onSubmit={handleSubmit}>
          <DialogHeader className="border-b border-border px-6 py-5">
            ...
            <DialogDescription>Registre uma movimentação no seu fluxo de caixa.</DialogDescription>
          </DialogHeader>
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    ...
                    >
                      ...
                      {form.data
                        ? format(new Date(form.data + "T00:00:00"), "dd 'de' MMM yyyy", {
                            locale: ptBR,
                          })
                        : "Selecionar"}
                    </Button>
